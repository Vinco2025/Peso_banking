<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Withdraw Money</h2>
            <p class="text-sm text-gray-500 mt-1">Withdraw funds from one of your accounts</p>
        </div>
    </x-slot>
        ...
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <p class="font-semibold text-gray-800">New Withdrawal</p>
                        <p class="text-xs text-gray-400">Make sure you have sufficient balance</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('withdraw') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <select name="account_id"
                                class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="amount" min="1" step="0.01"
                                value="{{ old('amount') }}"
                                class="w-full border border-gray-200 rounded-lg pl-7 pr-3 py-2.5 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent transition"
                                placeholder="0.00">
                        </div>
                        @error('amount')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <button type="submit"
                            class="w-full bg-red-600 hover:bg-red-700 text-white text-sm font-semibold py-3 rounded-lg shadow transition">
                        Confirm Withdrawal
                    </button>
